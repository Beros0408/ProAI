  ...
  return (
    <div className="max-w-2xl mx-auto animate-fade-in">
      <div className="text-center mb-10">
        ...
        <h1 className="text-2xl font-bold text-foreground">Nouvelle conversation</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {AGENT_TYPES.map(agent => (
          <Link
            ...
            className="group flex items-center gap-4 p-4 rounded-xl bg-surface border border-[#1E1E2E] hover:border-primary/50 hover:bg-primary/5 transition-all"
          >
