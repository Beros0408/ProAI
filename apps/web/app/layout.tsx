...
export const metadata: Metadata = {
  ...
  title: 'Krezia — Votre équipe IA pour développer votre business',
  ...
  keywords: 'IA, agents IA, SaaS, marketing IA, automatisation, CRM, analytics, Krezia',
  authors: [{ name: 'Krezia' }],
  creator: 'Krezia',
  openGraph: {
    type: 'website',
    ...
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Krezia Dashboard' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Krezia — Votre équipe IA',
